...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:ng="http://angularjs.org" class="no-js"><!--<![endif]-->
	...
	<body data-ng-app="advisorApp" id="advisorApp">
		 <!--[if lt IE 7]>
        ...
        <script src="scripts/modules/advisor/app.js"></script>

        <!--scripts: controllers -->
        <script type="text/javascript" src="scripts/modules/advisor/controllers/main.js"></script>
        <script type="text/javascript" src="scripts/modules/advisor/controllers/tools.js"></script>
        <script type="text/javascript" src="scripts/modules/advisor/controllers/review.js"></script>
        <!--///-->
        ...
        <!--///-->
      	...
      	<script src="bower/jsPDF/jspdf.js"></script>
      	<script type="text/javascript" src="bower/jsPDF/libs/Deflate/adler32cs.js"></script>
      	<script src="bower/jsPDF/libs/FileSaver.js/FileSaver.js"></script>
      	<script src="bower/jsPDF/libs/Blob.js/Blob.js"></script>
      	<script type="text/javascript" src="bower/jsPDF/libs/Blob.js/BlobBuilder.js"></script>
      	<script type="text/javascript" src="bower/jsPDF/jspdf.plugin.addimage.js"></script>

		<script type="text/javascript" src="bower/jsPDF/jspdf.plugin.standard_fonts_metrics.js"></script>
		<script type="text/javascript" src="bower/jsPDF/jspdf.plugin.split_text_to_size.js"></script>
		<script type="text/javascript" src="bower/jsPDF/jspdf.plugin.from_html.js"></script>
	</body>
</html>